...
function scoreScene:createScene( event )
	...
	local currentScoreLabel = ui.createLabel( self.view, "Current Score:", 25, 270, TOP_REF, LEFT_REF, true )
	
	display.remove( userScoreText )
	userScoreText = ui.createLabel( self.view, "0 Taps", display.contentWidth-25, 270, TOP_REF, RIGHT_REF )
...
function boardScene:createScene( event )
	...
	local boardLabel = ui.createLabel( self.view, "Leaderboard:", 25, 142, TOP_REF, LEFT_REF , true )
	
	display.remove( currentBoardText )
	currentBoardText = ui.createLabel( self.view, currentBoard, display.contentWidth-25, 142, TOP_REF, RIGHT_REF )
	
	local yourLabel = ui.createLabel( self.view, "Your Best", 25, 177, TOP_REF, LEFT_REF, true )
	
	display.remove( userBestText )
	userBestText = ui.createLabel( self.view, userBest, display.contentWidth-25, 177, TOP_REF, RIGHT_REF  )
	
	display.remove( bestLabel )
	bestLabel = ui.createLabel( self.view, topScorer .. " got:", 25, 212, TOP_REF, LEFT_REF, true )
	
	display.remove( bestText )
	bestText = ui.createLabel( self.view, bestTextValue, display.contentWidth-25, 212, TOP_REF, RIGHT_REF  )
