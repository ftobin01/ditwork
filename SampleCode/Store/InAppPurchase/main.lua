...
local titlecard
function showTitle()
	titlecard = display.newImage( "titlecard.png", centerX, centerY, true )
end
...
function addProductFields()
	...
	bg = display.newImage( "storebg.png", centerX, centerY, true )
	...
	if (not validProducts) or (#validProducts <= 0) then
		...
		descriptionArea.text = "Select a product..."
		descriptionArea:setTextColor(2/255, 0, 127/255)
		descriptionArea.size = 18
		descriptionArea.hasBackground = false
		descriptionArea.anchorX = 0
		descriptionArea.anchorY = 0
