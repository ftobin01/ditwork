...
local background = display.newImage( "aquariumbackgroundIPhone.jpg", centerX, centerY, true )
...
--
if isSimulator then
	msg = display.newText( "Multitouch not supported on Simulator!", 0, 20, "Verdana-Bold", 28 )
	msg.x = centerX		-- center title
	msg.y = centerY	-- center title
