...
/*
    ...
    [newManagedObject setValue: @"Mr Smiley McShaggy" forKey:@"courseLecturer"];
    [newManagedObject setValue: @"1407" forKey:@"courseRoom"];
    [newManagedObject setValue: @"timeStamp" forKey:@"courseName"];
  */
    //   NSLog(" NSMAnaged object ininsert NEwOBject = %s",[entity courseName);
