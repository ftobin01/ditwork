...
local debug_output_object_hit = function( hits )
	...
	do
		...
		if v.object == ground then
			object_name = "ground"
		elseif v.object == crate1 then
			object_name = "crate1"
		elseif v.object == crate2 then
			object_name = "crate2"
		elseif v.object == crate3 then
			object_name = "crate3"
		elseif v.object == crate4 then
			object_name = "crate4"
		else
			object_name = "unknown"
		end

		print( "Hit: ", i, object_name, " Position: ", v.position.x, v.position.y, " Surface normal: ", v.normal.x, v.normal.y, " Fraction: ", v.fraction )
	end
