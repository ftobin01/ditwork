...
function flash_delta()
	...
	delta_text = display.newText ( temp_delta, 160, 0, "Helvetica-Bold", 48)
...
title = display.newText ( "PubNub, Corona Labs Corona SDK\n& BeyondtheTech present", 260, 35, 400, 0, "Helvetica-Bold", 12)
title:setFillColor (1,128/255,1)

point_value_text = display.newText ( "Connecting...", centerX, 300, "Helvetica-Bold", 20)
point_value_text:setFillColor (1,1,0)

equation_text = display.newText ( "MATHEMANIA", centerX, 160, "Helvetica-Bold",80)
equation_text:setFillColor (1,1,1)
reset_equation_graphics()

your_score_text = display.newText ( "Your Score: 0", centerX, 460, "Helvetica-Bold", 24)
your_score_text:setFillColor (0,1,1)


game_clock_text = display.newText ( "", 20, 460, "Helvetica-Bold", 12)
game_clock_text:setFillColor(64/255 )

leaderboard_group = display.newGroup()
for i=1, 10 do
	leaderboard[i] = display.newText ( i .. ". " .. "(empty)", 40, 60 + (i*18), "Helvetica-Bold", 12)
	leaderboard[i].anchorX = 0.0
...
for i=1, 5 do
	...
	button[i].x = -32 + (64 * i)
	button[i].y = 380
	button_text[i] = display.newText ( "", button[i].x, button[i].y, "Helvetica-Bold", 20)
