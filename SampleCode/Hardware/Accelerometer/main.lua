...
-- Displays App title
title = display.newText( "Accelerator / Shake", centerX, 20, "Verdana-Bold", 20 )
...
--
if isSimulator then
	msg = display.newText( "Accelerometer not supported on Simulator", centerX, 55, "Verdana-Bold", 13 )
