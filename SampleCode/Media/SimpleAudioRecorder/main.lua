...
-- title
local title = display.newText( "Echo", centerX, 60, "AmericanTypewriter-Bold", 40 )
title:setFillColor( 1, 204/255, 102/255 )

local subTitle = display.newText( "Simple Audio Recorder", centerX, 0, "AmericanTypewriter-Bold", 22 )
...
local recordingStatus = display.newText( " ", centerX, 195, "AmericanTypewriter-Bold", 32 )
