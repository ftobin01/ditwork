...
titleMsg = display.newText( "Local Notification Test", centerX, 23, "Verdana-Bold", 18 )
...
--
if isSimulator then
	msg = display.newText( "Local Notifications not supported on Sim!", centerX, 7, "Verdana-Bold", 12 )
